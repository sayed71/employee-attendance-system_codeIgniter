...
class UserInfo extends CI_Controller 
{
	...
	{
		$data['Msg']=$this->user_info_model->First_data();
		$data['STU']=$this->user_info_model->SelectUserType();
		$data['SD']=$this->user_info_model->SelectUserType1();
		$this->load->view('UserInfoView',$data);
		//////////////////////////////////////////
		//$data['Msg']=$this->user_info_model->First_data_UT();
		//$this->load->view('UserTypeView',$data);
	}
	/////////////////////session unset//////////////////
	...
	public function ButtonWork()
	{
		...
		{*/
			...
			$data['STU']=$this->user_info_model->SelectUserType();
			$data['Msg']=$this->user_info_model->ButtonWorkModel($data['BtnValue']);
			$this->load->view('UserInfoView',$data);
		//}
	}
	/////////////////////////////////////////////////
	...
	{
		$this->load->view('UserTypeView');	
	}
	//////////////////////////////////////////////////
	public function ButtonWork_UT()
	{
		/*$this->load->library('form_validation');
		$this->form_validation->set_rules('txtUserName', 'User Name', 'required');
		$this->form_validation->set_rules('txtPassword', 'Password', 'required');
		...
		{*/
			...
			$data['Msg']=$this->user_info_model->ButtonWorkModel_UT($data['BtnValue']);
			$this->load->view('UserTypeView',$data);
		//}
	}
	///////////////////////////////////////////////
