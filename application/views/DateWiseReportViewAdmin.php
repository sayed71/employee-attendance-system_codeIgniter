    ...
    <div class="container">   
      ...
      <div class="panel-heading" style="text-align:center; font-size:20px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%">&nbsp;</td>
            <td width="70%" align="center"><span class="panel-heading" style="text-align:center; font-size:20px;">Date Wise Report<span class="form-group">
          ...
          <tr>
            ...
            <td><div style="width:200px;">
              <select id="SelectUserType" name="SelectUserType" class="form-control" title="Select user type" style=" color:#428bca;">
                <option value="select-one">Select Employee</option>
                <?php
