...
<!--    <link rel="stylesheet" href="<?php //print base_url(); ?>assets/css/datepicker.css">-->    
  ...
  <body>
  <?php echo form_open_multipart('adminInfo/ButtonWork') ?>
    <div class="container">   
      ...
      <div class="panel-heading" style="text-align:center; font-size:20px;">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td width="15%">&nbsp;</td>
            <td width="70%" align="center"><span class="panel-heading" style="text-align:center; font-size:20px;">Admin Information</span></td>
   ...
   <table width="70%" border="0" align="center" cellpadding="0" cellspacing="0" class="table">
          <tr>
            <td width="8%">&nbsp;</td>
            <td width="33%"><span style="color:#428bca;">User Name</span></td>
